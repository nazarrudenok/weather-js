...
function getWeather(position) {
    ...
    const URL = `https://api.weatherapi.com/v1/forecast.json?key=e43642ed5f89487c97c143549230706&q=${latitude},${longitude}&lang=uk&days=5`;
    ...
    xhr.onload = () => {
        ...
        location.innerHTML = `<h1 class="location-text">${response['location']['name']}, ${response['location']['country']}</h1>`
